...
# data importing 
data = pd.read_excel("Product Recommendation engine.xlsx")
...
def main():
    ...
    st.markdown("<h1 style='text-align: right; color: #d7e3fc; font-size: small;'><a href='https://github.com/akshaynarvate/Product-Recommendation-engine'>Looking for Source Code?</a></h1>", unsafe_allow_html=True)
